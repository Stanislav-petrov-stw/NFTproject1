...
contract NFTStaking is Ownable, IERC721Receiver {
    ...
    // structure to store a stake's token, owner and earnings values
    struct Stake {
        uint24 tokenId;
        uint48 timestamp;
        address owner;
    ...
    // Points to both NFT collection and Rewards Token Smart Contract
    Collection nft;
    N2DRewards token;

    // Referenced tokenId to stake
    ...
    function onERC721Received(
        ...
        require(from == address(0x0), "Cannot send nft to Vault directly");
